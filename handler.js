...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.img = 'https://i.postimg.cc/0yw4rS7y/ss.png'
        global.fla = pickRandom(global.flaaa)
        global.namabot = conn.user.name
        global.packname = '© Zerrx Bot'
        global.author = 'Made By FWD˚ © 2022'
        global.packname2 = 'Made With'
        global.author2 = 'Zerrx By F.W.D © 2022'
        global.wm3 = '·͟͟͟͟͟͟͞͞͞͞͞͞Made By FWD˚'
        global.wm2 = '© Zerrx Bot' + ' ' + 'By FWD'
        global.wm = '© Zerrx MD'
        global.colong1 = 'Ciss 📸'
        global.colong2 = 'By Fwd'
        global.kontak2 = [
        ['6281262166032', 'F.W.D', 'Creator Bot', 'fwd@support.com', true],
        ['6281377468079', 'Zerrx ', 'Bot WhatsApp', 'Just Bot', true]
        ]
...
global.dfail = async (type, m, conn) => {
    ...
    let msg = {
        rowner: 'Perintah ini hanya dapat digunakan oleh _*Team Bot Zerr!1!1!*_',
        owner: 'Perintah ini hanya dapat digunakan oleh _*Team Bot Zerr!1!1!*_',
        ...
        unreg: 'ʜᴀʟʟᴏ ᴋᴀᴋ ! 👋\nᴀɴᴅᴀ ʜᴀʀᴜs ᴍᴇɴᴅᴀғᴛᴀʀ ᴋᴇ ᴅᴀᴛᴀʙᴀsᴇ ʙᴏᴛ ᴅᴜʟᴜ sᴇʙᴇʟᴜᴍ ᴍᴇɴɢɢᴜɴᴀᴋᴀɴ ғɪᴛᴜʀ ɪɴɪ\n\n➞ ᴋᴇᴛɪᴋ .daftar ᴜɴᴛᴜᴋ ᴍᴇɴᴅᴀғᴛᴀʀ ᴋᴇ ᴅᴀᴛᴀʙᴀsᴇ ʙᴏᴛ',
        nsfw: 'NSFW tidak aktif, Silahkan hubungi Team Bot Zerr untuk mengaktifkan fitur ini!',
        rpg: 'RPG tidak aktif, Silahkan hubungi Team Bot Zerr Untuk mengaktifkan fitur ini!',
