...
const fkgif = {
	 ...
	 message: { 
		"extendedTextMessage": {
                 "text":`ZERRX BOT MD 🌱 ┊ 𝗥𝗣𝗚 Whatsapp ʙᴏᴛ`,
                 "title": `ZERRX BOT MD 🌱 ┊ 𝗥𝗣𝗚 Whatsapp ʙᴏᴛ`,
                 'jpegThumbnail': await (await fetch('https://i.postimg.cc/zffFsZ98/23.jpg')).buffer()
                        }
	                  } 
                     }
...
●────━───༺༻───━────●
                *《 BOT INFO 》*
⚘ *Bot Name: ZERRX BOT MD*
⚘ *Creator: F.W.D*
⚘ *Contact Owner Bot*
*http://wa.me/6281262166032*
⚘ *Tanggal: ${date}*  
⚘ *Jam: ${time} WIB*
⚘ *Status: 「 ${mode} 」*
⚘ *Prefix: 「 MULTI PREFIX 」*
 ...
       const sections = [
                              {
                                "rows": [{
                                         "title": "📊 › Status ",
                                         "description": "Status ZERRX BOT MD",
                                         "rowId": ".botstat"
                                    }, {
                                         "title": "⚡› Speed ",
                                         "description": "Menampilkan Kecepatan Respon ZERRX BOT MD",
                                         "rowId": ".ping"
                                    }, {
                                         "title": "🗒️› Info ",
                                         "description": "Menampilkan Info ZERRX BOT MD",
                                         "rowId": ".info"
                                    }, {
                                         "title": "🎐 › Developer Bot ",
                  ...
                  "rowId": ".? owner"
                                ...
                                "description": "Last Update Terakhir Di ZERRX BOT MD",
                                "rowId": ".notes"                  
                }],                
                                "title": "▮Last Update 」"
                                }, {
