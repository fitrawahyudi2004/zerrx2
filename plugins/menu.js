 ...
 *Powered By @${'6281262166032'.split('@')[0]}*`
 ...
     }) 
     if (teks == '404') {
 	let cute = `${pickRandom(['https://i.postimg.cc/0yw4rS7y/ss.png'])}` 
 	let ori = `Hi Kak, @${m.sender.split`@`[0]}
 
Saya Adalah Zerrx Bot Salah Satu Bot Whatsapp Yang Siap Membantu Kamu Mempermudah Sesuatu Seperti Membuat Sticker Dan Lainnya, Kalo Kamu Mau Request Fitur Silahkan Ketik #request Pesan Atau Fitur Yang Kamu Inginkan!`
...
type: 'audioMessage', 
ptt: true, contextInfo:{ externalAdReply: { title: `💌 Ultah Fitra : ${ohari} Hari ${ojam} Jam ${onet} Menit ${detek} Detik`, body: `${pickRandom(['Follow IG MY OWNER'])}`, sourceUrl: 'https://instagram.com/fitra_wahyudi_', thumbnail: await (await fetch('https://i.postimg.cc/zffFsZ98/23.jpg')).buffer(),}} 
     })
} catch (e) { 
